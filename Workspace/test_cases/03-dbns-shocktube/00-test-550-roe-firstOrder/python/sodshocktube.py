...
colsTp = np.loadtxt('../sets/0.0004/data_T_p.xy')
colsU = np.loadtxt('../sets/0.0004/data_U.xy')
...
plt.plot(colsTp[:,0],colsTp[:,2],marker='.',c='red',label='pre - openfoam')
...
plt.plot(colsU[:,0],colsU[:,1],marker='.',c='red', label='vel_mag - openfoam')
...
plt.plot(colsTp[:,0],colsTp[:,1]/(colsTp[:,1]*287.058),marker='.',c='red',label='rho - openfoam')
...
plt.plot(colsTp[:,0],colsTp[:,1],marker='.',c='red',label='Temperature - openfoam')
