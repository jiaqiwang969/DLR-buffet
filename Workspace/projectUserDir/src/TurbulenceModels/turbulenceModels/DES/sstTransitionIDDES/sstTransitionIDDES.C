...
const IDDESDelta& sstTransitionIDDES<BasicTurbulenceModel>::setDelta() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::alpha() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::ft
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::fl
(
    const volScalarField& magGradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::rd
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::fdt
(
    const volScalarField& magGradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> sstTransitionIDDES<BasicTurbulenceModel>::dTilda
(
    const volScalarField& magGradU,
...
template<class BasicTurbulenceModel>
sstTransitionIDDES<BasicTurbulenceModel>::sstTransitionIDDES
(
...
:
    sstTransitionDES<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool sstTransitionIDDES<BasicTurbulenceModel>::read()
{
    if (sstTransitionDES<BasicTurbulenceModel>::read())
    {
