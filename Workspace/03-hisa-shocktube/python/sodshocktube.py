...
cols = np.loadtxt('../postProcessing/sampleDict/0.0004/data_T_mag(U)_p.xy')
...
plt.plot(cols[:,0],cols[:,3],marker='.',c='red',label='pre - openfoam')
...
plt.plot(cols[:,0],cols[:,2],marker='.',c='red', label='vel_mag - openfoam')
...
plt.plot(cols[:,0],cols[:,3]/(cols[:,1]*287.058),marker='.',c='red',label='rho - openfoam')
...
plt.plot(cols[:,0],cols[:,1],marker='.',c='red',label='Temperature - openfoam')
