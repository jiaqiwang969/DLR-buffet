...
#include "characteristicPressureInletOutletPressureFvPatchScalarField.H"
...
characteristicPressureInletOutletPressureFvPatchScalarField
(
    const characteristicPressureInletOutletPressureFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
characteristicPressureInletOutletPressureFvPatchScalarField
(
    const characteristicPressureInletOutletPressureFvPatchScalarField& sfspvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void Foam::characteristicPressureInletOutletPressureFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::characteristicPressureInletOutletPressureFvPatchScalarField::write(Ostream& os) const
{
