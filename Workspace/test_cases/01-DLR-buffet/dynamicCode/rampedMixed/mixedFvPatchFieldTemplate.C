...
// dynamicCode:
// SHA1 = 94aeec4bc3e1a18bb3985904ca22d24786849109
//
// unique function name that can be checked if the correct library version
// has been loaded
extern "C" void rampedMixed_94aeec4bc3e1a18bb3985904ca22d24786849109(bool load)
{
    if (load)
    {
...
//{{{ begin code
    #line 34 "/lustre/home/acct-medgm/medgm/06-DLR-buffet/Workspace/test_cases/01-DLR-buffet/0/U.boundaryField.INLET"
const scalar t = this->db().time().value();
            const scalar pi = constant::mathematical::pi;

            const scalar frequency_=3000;
            const vector amplitude_=vector(1, 0, 0);
            const vector level_=vector(50, 0, 0);
